...
class Npscontroller {
    async execute(request: Request, response: Response) {
        ...
        //os passivos não entra no calculo, colocamos aqui só para ver mesmo
...
calculo:
(numero de promotores - numero de detratores) / (numero de respondentes(todos)) x 100
todos = detratores, passivos e promotores
*/